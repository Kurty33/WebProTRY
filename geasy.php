...
<head>
    ...
    <title>WEBPRO TicTacToe (Easy)</title>
    <link rel="stylesheet" href="gexpert.css">
</head>

<body>  
    <h1 id="title">X-O EASY MODE</h1>
    <video autoplay loop muted>
      <source src="geasybg.mp4" class="video" type="video/mp4">
    ...
    <div class="container">
      <div class="main-container">
        ...
        <div class="opponent-toggle">
          <a href="category.php" style="text-decoration: none" onmousedown="sound10.play()"><button>Back</button></a>
          <a style="text-decoration: none" onmousedown="sound11.play()"><button id="choosePlayer">Another Player</button></a>
          <button id="chooseAI" class="active"  onclick="sound12.play()">AI (EASY)</button>
        </div>  
        </div>
        <h2 id="results"></h2>
